...
A full-stack, config-driven SaaS web application that turns YouTube videos into structured content, summaries, notes, quizzes, and viral social media posts using the power of AI.
...
- **Glassmorphism UI:** Premium, modern design built with Tailwind CSS and CSS variables. Includes full Dark Mode support.
